...
var plugin = require('service-logging-node').LoggingSenecaPlugin;
...
or by using [LoggingSenecaClient](https://github.com/pip-services-infrastructure2/client-logging-node/NodeClientApiV1.md/#client_seneca)